...
//PRAGMA_SDIO_HEAP_LOCATION HCD_HandleTypeDef hhcd ATTRIBUTE_SDIO_HEAP_LOCATION;
...
USBH_StatusTypeDef USBH_LL_Init(USBH_HandleTypeDef * phost)
{
  ...
  /* Register Callbacks */
  HAL_HCD_RegisterCallback(hhcd, HAL_HCD_MSPINIT_CB_ID, HAL_HCD_MspInit);
  HAL_HCD_RegisterCallback(hhcd, HAL_HCD_MSPDEINIT_CB_ID, HAL_HCD_MspDeInit);
  HAL_HCD_RegisterCallback(hhcd, HAL_HCD_SOF_CB_ID, HAL_HCD_SOF_Callback);
  HAL_HCD_RegisterCallback(hhcd, HAL_HCD_CONNECT_CB_ID, HAL_HCD_Connect_Callback);
  HAL_HCD_RegisterCallback(hhcd, HAL_HCD_DISCONNECT_CB_ID, HAL_HCD_Disconnect_Callback);
  HAL_HCD_RegisterCallback(hhcd, HAL_HCD_PORT_ENABLED_CB_ID, HAL_HCD_PortEnabled_Callback);
  HAL_HCD_RegisterCallback(hhcd, HAL_HCD_PORT_DISABLED_CB_ID, HAL_HCD_PortDisabled_Callback);

  HAL_HCD_RegisterHC_NotifyURBChangeCallback(hhcd, HAL_HCD_HC_NotifyURBChange_Callback);
#else
  /* Setup Callbacks by hand! Should be already done by HAL_HCD_Init() call !!! */
