...
//States based on "DOC-78 rev 0 - D25 - Interaction Flow Diagram (4)" and "DOC-79 rev 0 D25 - User Scenario"
typedef enum {
    UNIT_INSTALLATION_STATE_START,							//1
    UNIT_INSTALLATION_STATE_IS_LID_CLOSED,					//2
    UNIT_INSTALLATION_STATE_CHECK_UV_LAMPS,					//3
    UNIT_INSTALLATION_STATE_LID_OPENED_UNAUTHORIZED_ERROR,	//4
    UNIT_INSTALLATION_STATE_OPEN_LID,						//5
    UNIT_INSTALLATION_STATE_IS_LID_OPEN,					//6
    UNIT_INSTALLATION_STATE_LID_FAILED_TO_OPEN_CHECK,		//7
    UNIT_INSTALLATION_STATE_LID_FAILED_TO_OPEN_ERROR,		//8
    UNIT_INSTALLATION_STATE_LID_FAILED_TO_OPEN_X_ERROR,		//9
    UNIT_INSTALLATION_STATE_WAS_UV_LIGHT_DETECTED,			//10
    UNIT_INSTALLATION_STATE_UV_LIGHT_ERROR,					//11
    UNIT_INSTALLATION_STATE_UV_LIGHT_X_ERROR,				//12
    UNIT_INSTALLATION_STATE_UV_LIGHT_CALIBRATION,			//13
    UNIT_INSTALLATION_STATE_SUCCESSFUL,						//14
}UnitInstallationState;

typedef enum {
    UNIT_CONTROL_STATE_START,								//1
    UNIT_CONTROL_STATE_CHECK_START,							//2
    UNIT_CONTROL_STATE_IS_LID_CLOSED,						//3
    UNIT_CONTROL_STATE_CHECK_UV_LAMPS,						//4
    UNIT_CONTROL_STATE_LID_OPENED_UNAUTHORIZED_ERROR,		//5
    UNIT_CONTROL_STATE_OPEN_LID,							//6
    UNIT_CONTROL_STATE_IS_LID_OPEN,							//7
    UNIT_CONTROL_STATE_LID_FAILED_TO_OPEN_CHECK,			//8
    UNIT_CONTROL_STATE_LID_FAILED_TO_OPEN_ERROR,			//9
    UNIT_CONTROL_STATE_LID_FAILED_TO_OPEN_X_ERROR,			//10
    UNIT_CONTROL_STATE_WAS_UV_LIGHT_DETECTED,				//11
    UNIT_CONTROL_STATE_UV_LIGHT_ERROR,						//12
    UNIT_CONTROL_STATE_UV_LIGHT_X_ERROR,					//13
    UNIT_CONTROL_STATE_SUCCESSFUL,							//14
}UnitControlState;
...
typedef enum {
    ...
    UNIT_DISINFECTION_STATE_LID_FAILED_TO_OPEN_CHECK,		//7
    UNIT_DISINFECTION_STATE_LID_FAILED_TO_OPEN_ERROR,		//8
    UNIT_DISINFECTION_STATE_LID_FAILED_TO_OPEN_X_ERROR,		//9
    UNIT_DISINFECTION_STATE_WAS_UV_LIGHT_DETECTED,			//10
    UNIT_DISINFECTION_STATE_UV_LIGHT_ERROR,					//11
    UNIT_DISINFECTION_STATE_UV_LIGHT_X_ERROR,				//12
    UNIT_DISINFECTION_STATE_SUCCESSFUL,						//13
    UNIT_DISINFECTION_STATE_CHECK_RUNS,						//14
    UNIT_DISINFECTION_STATE_CLEANING_REQUIRED,				//15
    UNIT_DISINFECTION_STATE_MAINTANCE_REQUIRED,				//16
