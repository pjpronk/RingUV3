...
//void FrontendApplication::gotoGraphicsEffectScreen()
//{
//    transitionCallback = touchgfx::Callback< FrontendApplication >(this, &FrontendApplication::gotoGraphicsEffectScreenImpl);
//    pendingScreenTransitionCallback = &transitionCallback;
//}
...
//void FrontendApplication::gotoGraphicsEffectScreenImpl()
//{
//    makeTransition< GraphicsEffectView, GraphicsEffectPresenter, touchgfx::NoTransition, Model >(&currentScreen, &currentPresenter, frontendHeap, &currentTransition, &model);
//}
